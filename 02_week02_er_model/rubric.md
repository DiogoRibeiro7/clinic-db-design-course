...
- Foreign keys and junction entities are used correctly.
- Entities cover all in-scope concepts.
- The model avoids obvious redundancy and anomalies.
